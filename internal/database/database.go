...
// NewFiles returns a service instance for the files database
// For PostgreSQL migration, we use the same database for both data and files
func NewFiles() Service {
	if filesDbInstance != nil {
